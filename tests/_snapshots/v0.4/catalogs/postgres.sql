...
\restrict MEIPBOGfPG8scOzrxISsMjmIM3pKSaiFWorsWNFP7KRuV671FOGsSUgfUZBY0fJ
...
--
-- Name: ducklake_file_variant_stats; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.ducklake_file_variant_stats OWNER TO postgres;
...
--
-- Name: ducklake_macro; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.ducklake_macro OWNER TO postgres;

--
-- Name: ducklake_macro_impl; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.ducklake_macro_impl OWNER TO postgres;

--
-- Name: ducklake_macro_parameters; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.ducklake_macro_parameters OWNER TO postgres;
...
--
-- Name: ducklake_sort_expression; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.ducklake_sort_expression OWNER TO postgres;

--
-- Name: ducklake_sort_info; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.ducklake_sort_info OWNER TO postgres;
...
--
-- Data for Name: ducklake_file_variant_stats; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: ducklake_macro; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: ducklake_macro_impl; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: ducklake_macro_parameters; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
version	0.4	\N	\N
created_by	DuckDB 7dbb2e646f	\N	\N
...
0	34eeb264-38c4-4f44-a7bb-0d06e1c417b0	0	\N	main	main/	t
\.
...
0	2026-05-03 09:19:02.144998+00	0	1	0
\.
...
--
-- Data for Name: ducklake_sort_expression; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: ducklake_sort_info; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
\unrestrict MEIPBOGfPG8scOzrxISsMjmIM3pKSaiFWorsWNFP7KRuV671FOGsSUgfUZBY0fJ
