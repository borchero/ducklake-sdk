...
\restrict n150MMBFKf86rUgZ1mASfUxphcIkJ7bi3GCBVvGRAOJiheptJtezype6NDAeXCZ
...
--
-- Name: ducklake_file_column_statistics; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ducklake_file_column_statistics (
    data_file_id bigint,
    table_id bigint,
    column_id bigint,
...
ALTER TABLE public.ducklake_file_column_statistics OWNER TO postgres;
...
COPY public.ducklake_data_file (data_file_id, table_id, begin_snapshot, end_snapshot, file_order, path, path_is_relative, file_format, record_count, file_size_bytes, footer_size, row_id_start, partition_id, encryption_key, partial_file_info) FROM stdin;
\.
...
--
-- Data for Name: ducklake_file_column_statistics; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.ducklake_file_column_statistics (data_file_id, table_id, column_id, column_size_bytes, value_count, null_count, min_value, max_value, contains_nan) FROM stdin;
\.
...
COPY public.ducklake_metadata (key, value) FROM stdin;
version	0.1
created_by	DuckDB 71c5c07cdd
...
COPY public.ducklake_schema (schema_id, schema_uuid, begin_snapshot, end_snapshot, schema_name) FROM stdin;
0	aad3f0a9-d262-4487-943a-bf000ec24701	0	\N	main
\.
...
0	2026-05-03 08:45:46.129+00	0	1	0
\.
...
COPY public.ducklake_snapshot_changes (snapshot_id, changes_made) FROM stdin;
...
COPY public.ducklake_table (table_id, table_uuid, begin_snapshot, end_snapshot, schema_id, table_name) FROM stdin;
\.
...
COPY public.ducklake_table_column_stats (table_id, column_id, contains_null, contains_nan, min_value, max_value) FROM stdin;
\.
...
\unrestrict n150MMBFKf86rUgZ1mASfUxphcIkJ7bi3GCBVvGRAOJiheptJtezype6NDAeXCZ
