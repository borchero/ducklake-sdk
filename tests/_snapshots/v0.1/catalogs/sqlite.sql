...
INSERT INTO ducklake_metadata VALUES('version','0.1');
INSERT INTO ducklake_metadata VALUES('created_by','DuckDB 71c5c07cdd');
INSERT INTO ducklake_metadata VALUES('data_path','data_files_sqlite/');
INSERT INTO ducklake_metadata VALUES('encrypted','false');
...
INSERT INTO ducklake_snapshot VALUES(0,'2026-05-03 10:45:40.515+02',0,1,0);
...
CREATE TABLE ducklake_schema(schema_id BIGINT PRIMARY KEY, schema_uuid VARCHAR, begin_snapshot BIGINT, end_snapshot BIGINT, schema_name VARCHAR);
INSERT INTO ducklake_schema VALUES(0,'3dce5260-5c68-4f9a-b0d5-d7eebae18dca',0,NULL,'main');
CREATE TABLE ducklake_table(table_id BIGINT, table_uuid VARCHAR, begin_snapshot BIGINT, end_snapshot BIGINT, schema_id BIGINT, table_name VARCHAR);
...
CREATE TABLE ducklake_file_column_statistics(data_file_id BIGINT, table_id BIGINT, column_id BIGINT, column_size_bytes BIGINT, value_count BIGINT, null_count BIGINT, min_value VARCHAR, max_value VARCHAR, contains_nan BIGINT);
...
CREATE TABLE ducklake_table_column_stats(table_id BIGINT, column_id BIGINT, contains_null BIGINT, contains_nan BIGINT, min_value VARCHAR, max_value VARCHAR);
